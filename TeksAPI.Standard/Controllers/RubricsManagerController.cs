...
{
    public partial class RubricsManagerController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static RubricsManagerController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static RubricsManagerController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new RubricsManagerController();
                    }
                }
                return instance;
            }
        ...
        /// </summary>
        /// <param name="sourcedId">Required parameter: The UUID that identifies the Competency Framework Rubric that is to be read from the service provider.</param>
        /// <return>Returns the Models.CFRubricType response from the API call</return>
        public Models.CFRubricType GetCFRubric(string sourcedId)
        {
            Task<Models.CFRubricType> t = GetCFRubricAsync(sourcedId);
        ...
        /// <param name="sourcedId">Required parameter: The UUID that identifies the Competency Framework Rubric that is to be read from the service provider.</param>
        /// <return>Returns the Models.CFRubricType response from the API call</return>
        public async Task<Models.CFRubricType> GetCFRubricAsync(string sourcedId)
        {
            ...
            _queryBuilder.Append("/CFRubrics/{sourcedId}");
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.CFRubricType>(_response.Body);
            }
            catch (Exception _ex)
            {
