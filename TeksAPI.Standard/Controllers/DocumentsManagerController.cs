...
{
    public partial class DocumentsManagerController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static DocumentsManagerController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static DocumentsManagerController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new DocumentsManagerController();
                    }
                }
                return instance;
            }
        ...
        /// </summary>
        /// <param name="limit">Optional parameter: This is used as part of the data pagination mechanism to control the download rate of data. The 'limit' defines the download segmentation value i.e. the maximum number of records to be contained in the response. The form of implementation is described in the corresponding binding document(s).</param>
        /// <param name="offset">Optional parameter: This is used as part of the data pagination mechanism to control the download rate of data. The 'offset' is the number of the first record to be supplied in the segmented response message. The form of implementation is described in the corresponding binding document(s).</param>
        /// <param name="sort">Optional parameter: This is used as part of the sorting mechanism to be use by the service provider. The 'sort' identifies the sort criteria to be used for the records in the response message. Use with the orderBy parameter. The form of implementation is described in the corresponding binding document(s).</param>
        /// <param name="orderBy">Optional parameter: This is used as part of the sorting mechanism to be use by the service provider. This defines the form of ordering for response to the sorted request i.e. ascending (asc) or descending (desc). The form of implementation is described in the corresponding binding document(s).</param>
        /// <param name="filter">Optional parameter: This is used for the data filtering mechanism to be applied by the service provider. It defines the filtering rules to be applied when identifying the records to be supplied in the response message. The form of implementation is described in the corresponding binding document(s).</param>
        /// <param name="fields">Optional parameter: This is used as part of the field selection mechanism to be applied by the service provider. This identifies the range of fields that should be supplied in the response message. The form of implementation is described in the corresponding binding document(s).</param>
        /// <return>Returns the Models.CFDocumentSet response from the API call</return>
        public Models.CFDocumentSet GetAllCFDocuments(
                int? limit = 100,
                int? offset = 0,
                string sort = null,
        ...
        {
            Task<Models.CFDocumentSet> t = GetAllCFDocumentsAsync(limit, offset, sort, orderBy, filter, fields);
        ...
        /// <param name="fields">Optional parameter: This is used as part of the field selection mechanism to be applied by the service provider. This identifies the range of fields that should be supplied in the response message. The form of implementation is described in the corresponding binding document(s).</param>
        /// <return>Returns the Models.CFDocumentSet response from the API call</return>
        public async Task<Models.CFDocumentSet> GetAllCFDocumentsAsync(
                int? limit = 100,
                int? offset = 0,
                string sort = null,
                Models.OrderByEnum? orderBy = null,
                ...
                List<string> fields = null)
        {
            ...
            _queryBuilder.Append("/CFDocuments");
            ...
            APIHelper.AppendUrlWithQueryParameters(_queryBuilder, new Dictionary<string, object>()
            {
                ...
                { "sort", sort },
                { "orderBy", (orderBy.HasValue) ? Models.OrderByEnumHelper.ToValue(orderBy.Value) : null },
                { "filter", filter },
                { "fields", fields }
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.CFDocumentSet>(_response.Body);
            }
            catch (Exception _ex)
            {
        ...
        public async Task<Models.CFDocument> GetCFDocumentAsync(string sourcedId)
        {
            ...
            //prepare query string for API call
            StringBuilder _queryBuilder = new StringBuilder(_baseUri);
            _queryBuilder.Append("/CFDocuments/{sourcedId}");
