...
{
    public partial class PackagesManagerController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static PackagesManagerController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static PackagesManagerController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new PackagesManagerController();
                    }
                }
                return instance;
            }
        ...
        /// </summary>
        /// <param name="sourcedId">Required parameter: The UUID that identifies the Competency Framework Document that is to be read from the service provider and supplied with all of its component artefacts.</param>
        /// <return>Returns the Models.CFPackage response from the API call</return>
        public Models.CFPackage GetCFPackage(string sourcedId)
        {
            Task<Models.CFPackage> t = GetCFPackageAsync(sourcedId);
        ...
        /// <param name="sourcedId">Required parameter: The UUID that identifies the Competency Framework Document that is to be read from the service provider and supplied with all of its component artefacts.</param>
        /// <return>Returns the Models.CFPackage response from the API call</return>
        public async Task<Models.CFPackage> GetCFPackageAsync(string sourcedId)
        {
            ...
            _queryBuilder.Append("/CFPackages/{sourcedId}");
            ...
            try
            {
                return APIHelper.JsonDeserialize<Models.CFPackage>(_response.Body);
            }
            catch (Exception _ex)
            {
