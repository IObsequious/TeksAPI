...
{
    public class CFRubricType : BaseModel 
    {
        ...
        private List<Models.CFRubricCriterion> cFRubricCriteria;
        ...
        public List<Models.CFRubricCriterion> CFRubricCriteria 
        { 
            get 
            {
                return this.cFRubricCriteria; 
            } 
            set 
            {
                this.cFRubricCriteria = value;
                onPropertyChanged("CFRubricCriteria");
            }
        }
    }
} 